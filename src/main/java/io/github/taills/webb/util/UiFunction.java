...
import io.github.taills.webb.ui.component.WebbRTextArea;
...
public class UiFunction {
   public static String setSyntaxEditingStyle(WebbRTextArea textArea, String fileName) {
      String style = null;
   ...
   public static int getFontType(String fontType) {
      String var1 = fontType.toUpperCase();
      byte var2 = -1;
      switch(var1.hashCode()) {
      case -2125451728:
         if (var1.equals("ITALIC")) {
            var2 = 1;
         }
         break;
      case 2044549:
